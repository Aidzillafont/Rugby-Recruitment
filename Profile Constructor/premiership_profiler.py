...
cols_to_transform = ['M', 'C', 'P', 'T', 'MT', 'TW', 'TC', 'DB', 'TA', 'O', 'CB', 'LW', 'LS']

for col in tqdm(cols_to_transform):
    df['{0}_per80m'.format(col)] = df[[col,'min_played']].apply(frequency_transformation, axis=1)
...
#take only players with more than 5 games
